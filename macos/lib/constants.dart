...
//! JSON file location assigned to a constant variable
const customerData = "assets/customer_data.json";

//! app's primary colors set as constants
...
//! app's image directories set as constants
...
//! app's icon directories set as constants
