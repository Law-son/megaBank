...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  //validates user inputs, sets state to display password changed successfully text animation on homescreen
  void _submit() {
    final isValid = _formKey.currentState!.validate();
    if (isValid) {
      context.read<PageIndex>().setFirstLoadTrue();
